---
source: https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/index.html
category: sme
docid: sme-content-ba-docs
scraped: 2026-06-12
---
...
Instead of dealing with raw JSON files, you can visually manage and configure the structure and properties of their content elements.

It allows you to add, delete, duplicate, and move elements within the structure tree, providing a dynamic and flexible content organization.
The editor also features a real-time preview, enabling you to see changes instantly.
...
![content editor full screen](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/content-editor-full-screen.png)
...
or a [Box](#configure-elements/box) that can contain other elements).

Behind the scenes, these elements are stored in a format similar to how web pages are built using components.
Each element includes:

* **namespace** – A reverse domain string (for example, `com.example.ui`) to group related elements and prevent name conflicts.
...
* **children** – Any other elements nested inside (for example, a row might have columns as children)
...
| Field Output | Not allowed | Any elements |
...
| Interactive List | **InteractiveListItem**(s), or **Group**(s), or **Conditional**(s) | Any elements |
| Interactive List Item (InteractiveListItem) | Any elements | **InteractiveList** |
| Link | Any elements | Any elements |
| Media Query | Any elements | Any elements |
...
1. [Autocomplete](#configure-elements/autocomplete): The Autocomplete element allows you to input text with autocompletion based on predefined options.
2. [Checkbox](#configure-elements/checkbox): The Checkbox element allows you to toggle between two states of a field.
3. [Checkbox Group](#configure-elements/checkbox-group): The Checkbox Group element allows you to select multiple options from a predefined list via checkboxes.
4. [Date Picker](#configure-elements/date-picker): The Date Picker element allows you to either select dates and times from a picker dialog or input them manually.
5. [Multi Select](#configure-elements/multi-select): The Multi Select element allows you to select multiple options from a dropdown list of predefined values.
6. [Radio](#configure-elements/radio): The Radio element allows you to select a single option from a list of predefined values via radio buttons.
7. [Select](#configure-elements/select): The Select element allows you to choose an option from a dropdown list of predefined values.
8. [Switch](#configure-elements/switch): The Switch element allows you to toggle between two states of a field.
9. [Text Area](#configure-elements/text-area): The Text Area element allows you to input and edit multiple lines of text.
10. [Text Line](#configure-elements/text-line): The Text Line element allows you to input and edit a single line of text.
...
![open model editor](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/open-model-editor.png)
...
![add new content model](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/add-new-content-model.jpg)

Figure 3. Add a New Content Model

A modal dialog will open that is similar to other model creation dialogs.

![new content model dialog](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/new-content-model-dialog.png)
...
* **Left Panel – Element Structure**:
  ...
  It functions like a tree view, allowing you to add, remove, duplicate, or rearrange elements.
...
* **Middle Panel – Canvas (WYSIWYG View)**:
  This is the live preview area where you can see how their content model will appear when rendered.
  It offers a "what you see is what you get" experience, helping you understand the visual impact of structural
  or content changes in real time.
* **Right Panel – Element Settings**:
  When an element is selected, this panel shows its configurable properties. You can modify values such as text,
...
The layout encourages experimentation and refinement, enabling you to build high-quality content models
without directly editing code or JSON.

![model tree](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/model-tree.jpg)
...
![model settings](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/model-settings.png)
...
You can choose from a variety of elements such as text blocks, images, videos, and layout components.
To insert an element, you need to either:
...
![element right click menu](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/element-right-click-menu.png)
...
You can duplicate any element on the content page by right-clicking on the desired element and selecting "Duplicate" from the context menu.
...
You can remove any element from the content page by right-clicking on the element and selecting "Delete" from the context menu.
Alternatively, you can delete an element using the top menu action bar after selecting the element.
...
![preview button](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/preview-button.png)

Figure 8. Preview Button

![preview window](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/preview-window.png)
...
Some elements in the Content Engine use Widgets components directly and expose style settings that override the Widgets theming configuration. Because these style overrides are applied on top of the Widget’s built-in theme, there is no way to remove them at the editor level once they are set — the reset functionality exists specifically to address this.

For example, the Button Widget has no padding defined in its theming configuration, but the Content Engine Button element may set one. Without the reset feature, there would be no way to remove that padding override in the editor and fall back to the Button Widget’s original theming behavior.

##### How Overrides Are Indicated

When a style setting overrides the underlying Widget theming configuration, the editor provides visual indicators:

* The overridden setting label is highlighted in blue, and its input field shows the customized value.
* A **blue dot** appears next to the section header (for example, **Dimensions**) to indicate that one or more settings within that section have been overridden.

For example, in the screenshot below, only **Padding** has been overridden (set to `8px`), while **Width**, **Height**, and **Margin** remain unspecified. The blue dot next to **Dimensions** signals that this section contains at least one override.

![style override indicator](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/style-override-indicator.png)

Figure 11. Style Override Indicators

##### How to Reset Settings

When a style setting has been overridden, a reset icon (circular arrow) appears next to the setting label. Clicking this icon removes the override, allowing the element to fall back to the Widget’s theming configuration.

![reset individual setting](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/reset-individual-setting.png)

Figure 12. Reset Icon on an Individual Setting

##### Section-Level Reset

When a section contains overrides, a reset icon also appears in the section header. Clicking this icon removes all style overrides within that section at once, restoring the Widget’s theming configuration for all related settings.

![reset section setting](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/reset-section-setting.png)

Figure 13. Reset Icon on a Section Header

|  |  |
| --- | --- |
|  | The reset icon and blue dot only appear when a style setting overrides the Widget’s theming configuration. If neither is visible, the settings are already using the Widget’s theming configuration. |
...
![width height config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/width-height-config.png)
...
![padding margin visualization](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/padding-margin-visualization.png)
...
![padding margin config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/padding-margin-config.png)
...
Different units can also be combined. For example, you can apply 10px padding on top, and 5% padding on right.
...
![border config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/border-config.png)
...
![initial color config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/initial-color-config.png)
...
![expanded color config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/expanded-color-config.png)
...
![initial background image config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/initial-background-image-config.png)
...
![shadow config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/shadow-config.png)
...
![event config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/event-config.png)
...
![box configuration layout](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/box-configuration-layout.png)
...
![grid config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/grid-config.png)
...
The input format should be a list of integer numbers from 1 to 12 inclusively, separated by spaces, for example, `3 6 3`.

![grid row responsive config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/grid-row-responsive-config.png)
...
![grid row example 1](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/grid-row-example-1.png)
...
![grid row example 2](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/grid-row-example-2.png)
...
![grid column config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/grid-column-config.png)
...
* **Font Size**: Adjust the size of the text.
  ...
  + Available options include various pixel sizes (for example, 12px, 14px, etc.).
...
![lexical toolbar](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/lexical-toolbar.png)

Figure 29. Paragraph Element Toolbar

##### Links Inside Paragraphs

You can add hyperlinks within paragraph text using the link button in the toolbar. When adding or editing a link, a dialog appears with the following options:

* **URL**: The destination URL for the link (required). Must be a valid URL starting with http:// or https://.
* **Open Link in New Tab**: When enabled, the link will open in a new browser tab. This is useful when you want users to stay on the current page while viewing linked content.
* **Title**: Optional tooltip text that appears when users hover over the link, providing additional context about the destination.
...
You can insert dynamic content from the Document Model directly into paragraph text using element references.

To insert an element reference, type `[/` while in edit mode. An autocomplete dropdown will appear showing available fields and groups. Select the desired element from the list.

![paragraph element reference selection](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/paragraph-element-reference-selection.png)

Figure 30. Element Reference Autocomplete

###### Field References

Field references display field values from the Document Model. After selecting a field, a settings dialog appears with these options:
...
When the paragraph is inside a Repeatable Group, you can display the current repetition index (1, 2, 3, etc.).

Type `[/` and select the repeatable group from the dropdown. Group index references appear as `IndexOf(/path/to/group)` in the editor.

|  |  |
| --- | --- |
|  | Only repeatable groups (with repeatability > 1) appear in the autocomplete. You can reference the immediate parent group or any ancestor repeatable groups. |
...
All rich text editing capabilities available in the Paragraph element are also available in Headings, including:
...
|  |  |
| --- | --- |
|  | Images always keep their original aspect ratio and are scaled so they fit fully inside the container without cropping or distortion.  Valid value types you can set for the container’s width/height:  * Pixels (for example, `320px`) – exact size. Pixel values take precedence when combined with percentages via responsive rules. * Percentages (for example, `50%`, `120%`) – relative to the parent container. Values greater than `100%` enlarge the container beyond the parent; the image still scales proportionally inside that larger box. (Result: the container may overflow the layout; the image remains fully visible.) * `auto` – lets the container shrink or expand based on layout and the image’s intrinsic size (still capped by any parent constraints).  Padding and margin accept standard CSS units (px, rem, %, etc.). Percentage padding and margins are always calculated relative to the container’s width—even for vertical (top/bottom) values—per CSS specifications, which may be unexpected if you assume vertical percentages are based on height. |
...
![static source image config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/static-source-image-config.png)

Figure 32. Static Source Configuration

![dynamic source image config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/dynamic-source-image-config.png)

Figure 33. Dynamic Source Configuration
...
![image advanced config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/image-advanced-config.png)

Figure 34. Advanced Image Configuration
...
These elements share similar [common configurations](#configure-elements/common) to control margin, padding, and borders, providing a consistent approach to styling.
However, while Numbered and Bulleted Lists can only contain other List elements or List Item elements,
List Item elements can contain any other element, including Paragraphs, Images, or even other list elements.
This flexibility allows you to create complex and content-rich list items that are easy to manage and style.
...
* **Open in new tab:** Enable this option to open the link in a new browser tab. This is useful when you want to keep the current page open while the linked content is being viewed in a separate tab.
* **Link Text:** This is the text that will be displayed for the link. It is important to provide a clear and concise label to indicate the purpose of the link.
* **Hide link text:** When enabled, the link text will be visually hidden but still available for screen readers. This is useful for icon-only links where the visual representation is sufficient, but accessibility requirements still need descriptive text.
* **Title:** Optional tooltip text that appears when users hover over the link. This provides additional context about the link destination. For icon-only links (when hide link text is enabled), the title is combined with the link text for better accessibility support.

##### Child Elements

The Link element can contain child elements, particularly Icon elements. This allows you to create icon-only links or links with icons alongside text. When a Link contains only an Icon child and the link text is hidden, the link text and title are combined to provide accessible hover text.

##### Dimensions

The dimensions section allows you to set padding and margin for the link element.

![link config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/link-config.png)

Figure 35. Link Element Configuration
...
![icon picker config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/icon-picker-config.png)

Figure 36. Icon Picker Configuration
...
![icon config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/icon-config.png)

Figure 37. Icon Element Configurations
...
* **Icon:** The specific icon to be displayed. If not set, the Message Box will use the *default icon* corresponding to the *variant* configuration.

![message box config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/message-box-config.png)

Figure 38. Message Box Element Configurations
...
![button config section 1](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/button-config-section-1.png)

Figure 40. Button Content Configurations
...
![button config section 2](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/button-config-section-2.png)

Figure 41. Button Variant Configurations

* **Advanced (Accessibility):** Additional settings for accessibility compliance.

  + **Aria Label**: A custom accessible name for the button. By default, the aria-label is automatically built by concatenating the Label and Description. If they contain similar or redundant content, you can specify a custom Aria Label to provide a cleaner accessible name without repetition.

|  |  |
| --- | --- |
|  | The Aria Label setting is particularly useful for icon-only buttons or buttons where the visible label and description might create redundant screen reader announcements. |

##### Button Group Configurations

The Button Group element allows you to group multiple buttons together, providing a consistent layout and styling for related actions. Use this when you have 2-5 related buttons that should be visually connected (for example, form actions, pagination controls, or toggle options).

* **Gap**: Defines the space between buttons in the group.

![button group config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/button-group-config.png)

Figure 42. Button Group Configurations

##### Button Group Container Configurations

The Button Group Container element allows you to organize two Button Groups together, providing a consistent layout and styling for related actions. Use this when you need to create complex toolbars or action bars with distinct sections (for example, primary actions vs. secondary actions, left-aligned vs. right-aligned buttons, or separating different functional categories).

* **Gap**: Defines the space between buttons in the group.
* **Alignment**: Defines the alignment of the button groups within the container.

![button group container config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/button-group-container-config.png)

Figure 43. Button Group Container Configurations
...
* **Title:** The title of the interactive tile. This text appears as a tooltip when users hover over the tile, providing additional context about the tile’s purpose or action.
* **Role:** Defines the semantic role of the interactive tile for accessibility purposes. Available options include:
...
![interactive tile config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/interactive-tile-config.png)

Figure 44. Interactive Tile Configurations

#### Table Elements

Besides [common configurations](#configure-elements/common) such as dimensions, shadow, and border, all the Table elements
...
* **Disable selected row styling:** When enabled, the selected row will not have the selected styling applied but will still retain its focus style. This is useful for tables that are not used in a master-detail context, where the selected state has no semantic meaning.
* **Screen Reader Column:** Improves accessibility for tables with action columns by appending a column’s text to button, checkbox, and interactive tile labels for screen readers. See [Screen Reader Column](#configure-elements/table/screen-reader-column) for details.

![table config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/table-config.png)

Figure 45. Table Configurations

##### Column Configurations

###### Actions

You can manage table columns with the following actions that can be triggered from row action buttons, pop-up menus, or right-click context menus:
...
![additional table column config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/additional-table-column-config.png)

Figure 46. Additional Column Configurations
...
You can provide a simple text value using the **Content** input or insert more complex elements,
such as paragraphs, images, and other content elements, inside the cell using the element insertion feature.

![table cell config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/table-cell-config.png)

Figure 47. Table Cell Configurations

##### Screen Reader Column

The **Screen Reader Column** feature improves accessibility for tables that contain interactive elements such as buttons, checkboxes, or interactive tiles in action columns.
When a table has multiple rows with identically labeled actions (for example, several "Delete" buttons), screen reader users cannot distinguish which button belongs to which row.
This feature connects those interactive elements with a descriptive column’s content, so a screen reader announces both the action label and the row context (for example, "Delete, Product ABC").

To enable the feature, select a column from the **Screen Reader Column** dropdown in the **Accessibility** section of the Table settings.

###### Requirements

* The selected column should contain only descriptive text (such as a name or title) that identifies the row.
* The column with interactive elements should be marked as an **Action Column**.
...
* **Initial status:** Set the initial appearance state of an expandable element. There are two available states: **Collapsed** (default) and **Expanded**.
...
![expandable config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/expandable-config.png)

Figure 48. Expandable Element Configurations

Switching between collapsed and expanded states of an expandable element could be achieved in two ways:

* Selecting the corresponding element in the components tree
* In canvas, a switch button would appear when hovering over an expandable element. Select this switch button to toggle between the corresponding collapsed and expanded states.

![expandable switch button](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/expandable-switch-button.png)

Figure 49. Switch Button to Toggle Between the Collapsed and Expanded States of an Expandable Element
...
Text elements (Paragraphs or Headings) inside a Repeatable Group can display the current repetition index (1, 2, 3, etc.).

To insert a group index reference: enter edit mode in the text element, type `[/`, and select the repeatable group from the dropdown. The reference appears as `IndexOf(/path/to/group)` in the editor.

See [Paragraph element](#configure-elements/paragraph) for more details on element references.

#### Media Query Element

The Media Query element allows you to create responsive content that displays or hides based on the current screen size. This is essential for building layouts that adapt to different devices and viewport sizes.

##### How It Works

The Media Query element acts as a container that conditionally renders its children based on defined screen size conditions. When the current viewport matches the specified queries, the content inside the Media Query element is displayed; otherwise, it is hidden.
...
You can define one or more queries to control when the content is displayed. Each query specifies a screen size and a condition type.

* **Operator:** When multiple queries are defined, this setting determines how they are combined:

  + **OR (any query matches)**: The content is displayed if any one of the queries matches the current screen size. This is the default behavior.
  + **AND (all queries match)**: The content is displayed only when all queries match the current screen size.

|  |  |
| --- | --- |
|  | The operator setting is only enabled when two or more queries are defined. |
...
* **Condition Type:** How the screen size should be matched:
  ...
  + **Only (exact match)**: The content is displayed only when the viewport exactly matches the specified screen size.
  + **From (size and larger)**: The content is displayed when the viewport is the specified size or larger.
  + **To (size and smaller)**: The content is displayed when the viewport is the specified size or smaller.
...
|  |  |
| --- | --- |
|  | Use the Media Query element to create content that adapts seamlessly to different devices, improving user experience across all screen sizes. |

#### Conditional Element

The Conditional element allows you to show or hide content based on field values in the Document Model. This is essential for creating dynamic forms and content that adapts based on user input or data state.

##### How It Works

The Conditional element acts as a container that conditionally renders its children based on defined conditions. When all conditions evaluate to true, the content inside the Conditional element is displayed; otherwise, it is hidden.
...
You can define one or more conditions to control when the content is displayed. Each condition compares a field value against a specified value using an operator.

|  |  |
| --- | --- |
|  | All conditions must evaluate to true for the content to be displayed (AND logic). If any condition evaluates to false, the content is hidden. |

###### Condition Configuration

Each condition has three settings:

* **Field Reference:** Select a field from the Document Model to evaluate. Use the autocomplete to find and select available fields. The field path is displayed (e.g., `root/customer/status`).
...
|  |  |
| --- | --- |
|  | An empty value input is treated as `undefined`. This allows you to check if a field has no value set. |
...
The content inside the Conditional element will only appear when the customer type field equals "Business".
...
|  |  |
| --- | --- |
|  | Use the Conditional element to create intuitive, dynamic forms that guide users through relevant options based on their previous selections. |

#### Tooltip Element

The Tooltip element displays contextual information in a small popup when users interact with content. Tooltips are useful for providing hints, displaying validation messages, or showing status information without cluttering the interface.

##### How It Works

The Tooltip element renders as a small popup that contains a text message. The appearance and styling of the tooltip depends on its type, making it easy to convey different kinds of information at a glance.
...
* **Hint:** A neutral tooltip for general information or guidance. Use this for helpful tips or explanations.
* **Error:** A tooltip styled to indicate an error condition. Use this for validation errors or critical issues.
* **Warning:** A tooltip styled to indicate a warning. Use this for cautionary messages or potential issues.
* **Success:** A tooltip styled to indicate success. Use this for confirmation messages or positive feedback.

###### Invert

Toggle this option to invert the tooltip colors. This can be useful for ensuring visibility against different background colors.

###### Text

Enter the message to display in the tooltip. This is the content users will see when the tooltip is shown.
...
|  |  |
| --- | --- |
|  | Choose the appropriate tooltip type to help users quickly understand the nature of the message being displayed. |

#### Field Output Element

The Field Output element displays a document field as a label-value pair using the Widgets Text Output. It references a field from the document model by its field ID and automatically renders the field’s label and current value at runtime.

This element is ideal for building summary pages or read-only views where data needs to be displayed in a consistent, theme-aware format without the need for manual styling.

##### How It Works

The Field Output element connects to a specific field in the document model. At runtime, it:

* Reads the field label from the document model definition
* Reads the current field value from the document data
* Renders both as a label-value pair using the Text Output widget

In the Content Model Editor (WYSIWYG), the field value is represented as a placeholder in the format **[/model/path/to/field]**, allowing you to see which field is referenced without requiring live document data.

![field output wysiwyg](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/field-output-wysiwyg.png)

Figure 50. Field Output Placeholder in the WYSIWYG Editor

##### Configuration Options

###### Field Reference

Select the document model field to display. The editor provides an autocomplete dropdown listing all available fields, using the same field set as the Paragraph element’s field reference.

|  |  |
| --- | --- |
|  | If the referenced field does not exist or has been removed from the document model, a validation error will be shown in the editor. |

###### Display Option

Controls how the field is rendered:

* **Value Only**: Displays only the field value without the label.
* **With label** (default): Displays both the field label and its value side by side.

###### Default Text

A fallback text displayed when the referenced field has no value. Defaults to "no data". This allows you to provide a meaningful placeholder for empty fields in the rendered output.

###### Alignment

Controls the text alignment of the Field Output:
...
Standard [margin and padding](#_margin_and_padding) settings to control the spacing of the element.

![field output config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/field-output-config.png)

Figure 51. Field Output Configurations

#### Interactive List Element

The Interactive List element renders a vertically stacked list of clickable items using the Widgets List. It is designed for navigation menus, action lists, or any scenario where users select from a set of interactive options.

|  |  |
| --- | --- |
|  | **Interactive List vs. Numbered/Bulleted List:**  * **Interactive List**: A behavioral list with clickable items, hover effects, and event support. Each item can trigger actions such as navigation or data operations. * **Numbered/Bulleted List**: A static content list for displaying ordered or unordered information without interactivity.  Use Interactive List when items need to respond to user clicks. Use Numbered/Bulleted List for purely informational content. |

##### Structure

When you add an Interactive List element to your content model, it is created with three Interactive List Items by default. You can add or remove items as needed.

The Interactive List accepts the following child elements:

* **Interactive List Item** — the primary content item (see below)
* **Group** — for organizing items dynamically
* **Conditional** — for conditionally showing or hiding items

![interactive list model tree](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/interactive-list-model-tree.png)

Figure 52. Interactive List Structure in the Model Tree

##### Interactive List Configuration

###### Divider

Toggle this option to display visual divider lines between all list items. This improves readability when items contain multi-line content or when clear visual separation is needed.

###### Border

Toggle this option to render a border around the entire list container.

###### Dimensions

Standard [margin and padding](#_margin_and_padding) settings to control the spacing of the list.

![interactive list config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/interactive-list-config.png)

Figure 53. Interactive List Configurations

##### Interactive List Item Configuration

The Interactive List Item element represents a single entry within an Interactive List. It supports text content, click events, and can contain child elements for rich layouts.

|  |  |
| --- | --- |
|  | Interactive List Items can only be placed inside an Interactive List element. |

###### Content

* **Text**: The primary text displayed in the list item.
* **Secondary Text**: An optional subtitle or description displayed below the primary text.

If child elements are added to the list item (e.g., a Paragraph or other elements), they replace the text property, allowing for rich content layouts within each item.

###### Click Event

Define the action triggered when the user clicks the list item. This follows the same [event configuration](#_event) as other interactive elements:

* **Event name**: A string representing a custom event for the project developer to handle.
* **Event node**: A reference to an [Action element](#configure-elements/action-elements) for built-in actions.

###### Confirmation

When a click event is configured, you can optionally enable a confirmation dialog that appears before the action is executed. The dialog can be customized with:

* **Title**: The dialog heading
* **Message**: The confirmation message
* **Confirm Label**: Text for the confirm button
* **Cancel Label**: Text for the cancel button

This is useful for destructive or irreversible actions triggered from list items.

###### Divider

Toggle this option to display a divider line below this specific item, independent of the list-level divider setting. This allows fine-grained control over visual separation between individual items.

###### Dimensions

[Margin](#_margin_and_padding) settings for the list item.

![interactive list item config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/interactive-list-item-config.png)

Figure 54. Interactive List Item Configurations
...
[Interactive Tile element](#configure-elements/interactive-tile),
or [Interactive List Item element](#configure-elements/interactive-list). The table below provides an overview of the available Action Elements and their configurations.
...
![element reference config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/element-reference-config.png)

Figure 55. Element Reference Configuration
...
![localized text config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/localized-text-config.png)

Figure 56. Localized Text Configuration
...
Placeholder texts are only available for text input elements. The defined text will be displayed in the input as long as no value has been entered.
...
![additional settings](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/additional-settings.png)

Figure 57. Additional Settings of an Input Element
...
|  |  |
| --- | --- |
|  | Inputs for computed fields are always shown as read-only, regardless of this setting. |
...
![annotations config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/annotations-config.png)

Figure 58. Annotations of an Input Element
...
![date picker config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/date-picker-config.png)

Figure 59. Date Picker Configuration
...
![radio config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/radio-config.png)

Figure 60. Radio Configuration
...
![switch label config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/switch-label-config.png)

Figure 61. Switch Label Configuration
...
![text area config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/text-area-config.png)

Figure 62. Text Area Configuration
...
![text line suffix](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/text-line-suffix.png)

Figure 63. Text Line Suffix Configuration
...
![text line config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/text-line-config.png)

Figure 64. Text Line Additional Settings
...
![message group container config](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/message-group-container-config.png)

Figure 65. Message Group Container Configuration
...
![message group container autoCollection](https://geta12.com/docs/2025.06/ext5/sme/sme-content-ba-docs/assets/images/message-group-container-autoCollection.png)

Figure 66. Message Group Container with active automatic collection

**Ignore formal errors** controls whether the configuration will apply to all messages or if formal errors should be excluded. In this case, formal errors on referenced fields will still be displayed at the respective input elements.

Enabling **automatically collect fields and groups** collects all of the used element references inside a Message Group Container and displays them in two separate tables.
