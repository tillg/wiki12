// Entry for the wiki12 web client, rebuilt on the A12 Client framework
// (specs/changes/a12-client-rebuild). Auth-gates on the existing UAA login, then
// mounts the A12 Client <Component> — whose ApplicationFrame layout is wiki12's
// chrome — with URL↔activity routing. The legacy React-Router SPA (App.tsx) is
// retired; see docs/adr.
